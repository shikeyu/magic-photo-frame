const translations = {
    "zh": {
        ...
        "qa_upload_sub_hint": "支持 JPG/PNG/GIF",
        "qa_crop_hint": "拖拽调整裁切范围 (固定 3:4)",
        "qa_prompt_label": "提示词 (必填，支持多行，每行一条)",
        "btn_confirm": "确定",
        "msg_alert_prompt_required": "请输入提示词",
        "msg_add_success": "添加成功",
        "lbl_save_load_config": "包含工作流与设置",
    ...
    "en": {
        ...
        "qa_upload_sub_hint": "Supports JPG/PNG/GIF",
        "qa_crop_hint": "Drag to Adjust Crop (Fixed 3:4)",
        "qa_prompt_label": "Prompts (Required, one per line)",
        "btn_confirm": "Confirm",
        "msg_alert_prompt_required": "Please enter prompt text",
        "msg_add_success": "Added successfully",
        "lbl_save_load_config": "Include Workflow & Config",
