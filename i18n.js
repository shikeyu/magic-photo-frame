const translations = {
    "zh": {
        ...
        "modal_quick_add_title": "快捷添加图片",
        "qa_upload_hint": "点击或拖拽上传图片",
        "qa_crop_hint": "拖拽调整裁切范围 (固定 3:4)",
        "qa_prompt_label": "提示词 (必填)",
        "btn_confirm": "确定",
        "msg_alert_prompt_required": "请输入提示词",
    ...
    "en": {
        ...
        "modal_quick_add_title": "Quick Add Image",
        "qa_upload_hint": "Click or Drop to Upload",
        "qa_crop_hint": "Drag to Adjust Crop (Fixed 3:4)",
        "qa_prompt_label": "Prompt (Required)",
        "btn_confirm": "Confirm",
        "msg_alert_prompt_required": "Please enter prompt text",
